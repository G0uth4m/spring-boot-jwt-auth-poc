...
insert into app_user (user_id, username, name, password, email, profile_pic_url, created_at, updated_at) values (1, 'admin', 'Administrator', '$2a$12$bYkGn0CpHDh5HhnYCM1pZOW342oAF.tnGjWemP51Q1UwVPYwIW6MC', 'admin@test.com', 'https://test.com/admin.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
